...
//    @Query(value = "select * from orders where book_size > 0 and (person_id in (select id from person where concat(name,code) like :key)) and id in (select order_id from order_detail where status = true)",nativeQuery = true)
    @Query(value = "select * from orders where book_size > 0 and (person_id in (select id from person where lower(concat(name,code)) like lower(:key))) and id in (select order_id from order_detail where status = 1)",nativeQuery = true)
...
//    @Query(value = " select * from orders where id in (select order_id from order_detail where book_id = :id and status = true and date_off is null)", nativeQuery = true)
    @Query(value = " select * from orders where id in (select order_id from order_detail where book_id = :id and status = 1 and date_off is null)", nativeQuery = true)
...
//        @Query(value = "select * from orders where person_id = :id and id in (select order_id from order_detail where status = true and date_off is null)", nativeQuery = true)
        @Query(value = "select * from orders where person_id = :id and id in (select order_id from order_detail where status = 1 and date_off is null)", nativeQuery = true)
...
@Query(value = "select * from orders where book_return > 0 and (person_id in (select id from person where lower(concat(name,code)) like lower(:key))) and id in (select order_id from order_detail where status = 1)",nativeQuery = true)
